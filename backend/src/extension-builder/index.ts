...
export default {
    async fetch(request: Request, env: Env): Promise<Response> {
        ...
        mcp.registerTool('generate_extension', {
            ...
            description: 'Generate a browser extension based on a prompt. Returns a job ID to track progress.',
                ...
                content: [
                    {
                        ...
                        text: JSON.stringify({
                            jobId,
                            status: 'pending',
                            message: 'Extension generation started. Use check_status with jobId to track progress.'
                        }, null, 2)
                    }
                ]
            };
