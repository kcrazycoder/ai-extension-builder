                    ...
                    suggestions: {
                      ...
                      items: {
                        ...
                        properties: {
                          label: {
                            type: 'string',
                            description: "Professional Title (e.g. 'Salesforce Data Clipper')",
                          },
                          description: {
                            type: 'string',
                            description: "Value proposition (e.g. 'Extracts lead data from LinkedIn...')",
                          },
                          prompt: {
                            type: 'string',
                        ...
                        required: ['label', 'description', 'prompt', 'complexity'],
                      },
                    },
                  },
              ...
              function: {
                ...
                parameters: {
                  ...
                  properties: {
                    ...
                    implementation_strategy: { type: 'string', description: 'High-level technical approach (e.g. "Use Storage API for persistence, Alarms for timing").' },
                    summary: { type: 'string', description: 'Brief summary of the extension.' },
                    async_logic_check: { type: 'string', description: 'Self-check: Are async listeners returning true?' },
                    data_contract_check: { type: 'string', description: 'Self-check: Is data passing correctly between parts?' },
                    ui_event_handling_check: { type: 'string', description: 'Self-check: Is UI responsive?' },
                    storage_async_check: { type: 'string', description: 'Self-check: Is storage accessed asynchronously?' },
                    ux_interactivity_check: { type: 'string', description: 'Self-check: Does it feel interactive?' },
                  },
                  required: [
                    'user_intent',
