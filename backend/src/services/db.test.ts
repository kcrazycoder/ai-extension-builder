...
describe('DatabaseService', () => {
  ...
  describe('updateExtensionStatus', () => {
    ...
    it('should update status and zipKey', async () => {
      ...
      expect(mockDb.prepare).toHaveBeenCalledWith(expect.stringContaining('UPDATE extensions SET'));
    ...
    it('should update name and description', async () => {
      ...
      expect(mockDb.prepare).toHaveBeenCalledWith(expect.stringContaining('description = ?'));
      expect(mockDb.prepare).toHaveBeenCalledWith(expect.stringContaining('summary = ?'));
      expect(mockBind).toHaveBeenCalledWith(
        'completed',
        'Test Extension',
        'A test extension',
        'Built a test extension.',
        'test-id'
      );
    });
  });
